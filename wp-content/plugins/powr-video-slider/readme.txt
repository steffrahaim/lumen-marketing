...
Tags: responsive slider, responsive video, responsive video slider, slider, slideshow, video, video slider, video player
...
Video Slider lets you play videos from YouTube or Vimeo in a responsive slider. Customize playback behavior, captions, animations, design, and more.
...
<br>
<br>
First, download, install, and activate POWr Video Slider. Then drop the plugin anywhere in your theme. Or add to a page/post with the POWr icon in the WP editor.
<br>
= <a href='https://www.powr.io/tutorials/how-to-add-video-slider-plugin-to-your-wordpress-site'>Click Here for 2 Minute Install Tutorial</a> =
<br>
= Free Features =
...
= <a href='https://www.powr.io/plugins/video-slider'>More Info</a> =
<br>

= LIVE EDITING =
POWr Video Slider plugin is simple to customize, directly inside of your live WordPress website. Just click on the Settings Icon to open the POWr Editor. You can now edit the design and contents of your Video Slider plugin. See your changes in real time, on your actual site. No need to ever leave the page. Just edit and save right in the POWr Editor.
<br>
= MOBILE RESPONSIVE =
...
<br>
= <a href='http://www.powr.io/tutorials/how-to-add-video-slider-plugin-to-your-wordpress-site'>Click Here for 2 Minute Install Tutorial</a> =
...
= How do I add Video Slider to a page or blog post? = Create and save the plugin in your WP Dashboard.  Then copy and paste the unique shortcode into any page or post. You can continue editing the plugin on your live page, in your WP Dashboard, or by logging in to www.powr.io.

= How do I add Video Slider to a theme?  = In your WP Dashboard, select Appearance > Widgets from the left sidebar. Find Video Slider under Available Widgets and drag it into a sidebar or footer.  Then visit the live page to set up the plugin.

= Can I add more than one Video Slider? = Yes, absolutely!  To clone an existing Video Slider, paste the exact same unique shortcode into another page or post.  To create a new version, select Video Slider from the sidebar in your WP Dashboard and click Create New.  You can then edit and save a new version, and paste the new unique shortcode into a page or post.

= Will my users see the Edit button above Video Slider? = No! You only see the Edit button because you own the plugin. To temporarily hide it, click on your page and then type 'p + down arrow' (the letter p followed by the down arrow). You can show the icon again by typing 'p + up-arrow'.
