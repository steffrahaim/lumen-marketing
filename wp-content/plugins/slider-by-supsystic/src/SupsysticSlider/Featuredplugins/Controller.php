...
/**
 * Class SupsysticSlider_Featuredplugins_Controller
 * Featuredplugins page controller
 *
 * @package SupsysticSlider\Featuredplugins
 */
class SupsysticSlider_Featuredplugins_Controller extends SupsysticSlider_Core_BaseController
{
    /**
